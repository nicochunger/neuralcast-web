...
const englishMessages: Record<TranslationKey, string> = {
    ...
    "favorites.description": "Songs you saved from the live stations.",
    ...
    "stations.introTitle": "Real music. A voice of its own.",
    "stations.introDescription": "100% human-made music, with AI hosts to keep you company",
    "station.description.neuralcast": "A wide mix of genres, eras, and discoveries.",
    "station.description.neuralforge": "Pure metal. From melodic to heavy.",
...
const messages: Record<Locale, Record<TranslationKey, string>> = {
  ...
  es: {
    ...
    "favorites.description": "Las canciones que guardaste de las emisoras en vivo.",
    ...
    "stations.introTitle": "Música real. Una voz propia.",
    "stations.introDescription": "Música 100 % hecha por humanos, con locutores de IA para hacerte compañía",
    "station.description.neuralcast": "Una mezcla de géneros, épocas y descubrimientos.",
    "station.description.neuralforge": "Puro metal. De lo melódico a lo pesado.",
  ...
  fr: {
    ...
    "stations.introTitle": "De la vraie musique. Une voix bien à elle.",
    "stations.introDescription": "De la musique 100 % créée par des humains, avec des animateurs IA pour vous tenir compagnie",
    "station.description.neuralcast": "Un mélange de genres, d’époques et de découvertes.",
    "station.description.neuralforge": "Du pur metal. Du mélodique au plus intense.",
